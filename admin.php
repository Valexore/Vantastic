            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo htmlspecialchars($ticket['terminal_name']); ?> to <?php echo htmlspecialchars($ticket['destination_name']); ?></td>
                  <td><?php echo date('M d, Y', strtotime($ticket['travel_date'])); ?></td>
                  <td><span class="status-badge status-<?php echo strtolower($ticket['status']); ?>"><?php echo ucfirst($ticket['status']); ?></span></td>
                </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
